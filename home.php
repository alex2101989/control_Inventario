            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        ?>
                        <!-- end precio total card -->



                        <!--  total productos disponibles card -->
                        <?php
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total de costo por Categoria Carnes</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">'
                                . 'Q' . number_format($fila['totalxCategoria'], 2) .
                                '</div>
                                        </div>
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total de costo por Categoria Ropa</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">'
                                . 'Q' . number_format($fila['totalxCategoria'], 2) .
                                '</div>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 col-lg-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <div
                                        ...
                                        <h6 class="m-0 font-weight-bold text-primary">Gráfico de Barras  grafico 1</h6>
                            ...
                            <!-- graffico de chart de pai -->
                            <div class="col-xl-5 col-lg-5">
                                <div class="card shadow mb-4">
                                    <!-- Card Header - Dropdown -->
                                    <div
                                        class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Gráfico de PIE  GRÁFICO 2</h6>
                                    ...
                                    <!-- GRáfico de PIE -->
                                    <div class="card-body">
                                        <div id="graficoPie1">Gráfico 2</div>
                                    </div>
                                </div>
                            </div>
...
<div class="col-xl-7 col-lg-7">
    <div class="card shadow mb-4">
        ...
        <!-- aquí va el Card Body -->
        <div class="card-body">
            <div id="graficoCol2">Gráfico 3</div>
        </div>
    </div>
</div>
...
<!-- END ROW -->
                ...
                <!-- Con el siguiente codigo estamos llamando al grafico src="script_graficos/ColumnChart.js -->
